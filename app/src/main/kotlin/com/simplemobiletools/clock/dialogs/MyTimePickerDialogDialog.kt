...
class MyLongTimePickerDialogDialog(val activity: SimpleActivity, val initialMilliseconds: Long, val callback: (result: Long) -> Unit) {
    private val binding = DialogMyTimePickerBinding.inflate(activity.layoutInflater)
    ...
    private fun dialogConfirmed() {
        /*binding.apply {
            ...
            val minutes = myTimePickerMinutes.value
            val seconds = myTimePickerSeconds.value
            val milliseconds = myTimePickerMilliseconds.value
            callback(hours * 3600 + minutes * 60 + seconds + milliseconds)
        }*/
    }
}
